...
public:
    ...
    void updateGUI() override
    {
        ...
        if (ImGui::Begin("MIPT OpenGL Sample", NULL, ImGuiWindowFlags_AlwaysAutoResize))
        {
            ...
            ImGui::Checkbox("Back face culling", &_backFaceCull);
        }
        ImGui::End();
    }
    ...
    void draw() override
    {
        ...
        glFrontFace(GL_CCW);
        glCullFace(_backFaceCull ? GL_BACK : GL_FRONT);
