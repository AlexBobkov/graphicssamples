...
public:
	...
	virtual void makeScene()
	{
		...
		_quadShader.createProgram("shaders7/quad2.vert", "shaders7/quad2.frag");
    ...
    void drawToFramebuffer(const CameraInfo& camera)
    {
        ...
        {
            _mrtShader.setMat4Uniform("modelMatrix", cube.modelMatrix());
            _mrtShader.setMat3Uniform("normalToCameraMatrix", glm::transpose(glm::inverse(glm::mat3(camera.viewMatrix * cube.modelMatrix()))));

            cube.draw();
        }

        {
            _mrtShader.setMat4Uniform("modelMatrix", sphere.modelMatrix());
            _mrtShader.setMat3Uniform("normalToCameraMatrix", glm::transpose(glm::inverse(glm::mat3(camera.viewMatrix * sphere.modelMatrix()))));

            sphere.draw();
        }

        {
            _mrtShader.setMat4Uniform("modelMatrix", bunny.modelMatrix());
            _mrtShader.setMat3Uniform("normalToCameraMatrix", glm::transpose(glm::inverse(glm::mat3(camera.viewMatrix * bunny.modelMatrix()))));

            bunny.draw();
        }

        {
            _mrtShader.setMat4Uniform("modelMatrix", ground.modelMatrix());
            _mrtShader.setMat3Uniform("normalToCameraMatrix", glm::transpose(glm::inverse(glm::mat3(camera.viewMatrix * ground.modelMatrix()))));
