...
void main()
{
	vec3 modelPos = positions[gl_InstanceID];

	posCamSpace = viewMatrix * modelMatrix * vec4(vp + modelPos, 1.0); //преобразование координат вершины в систему координат камеры
